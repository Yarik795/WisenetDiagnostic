...
7. Если уместен график — сначала run_sql, затем make_chart с именами колонок из результата.
8. Отвечай на русском, кратко и по делу. SQL можно показать пользователю в ответе.
9. credentials и config.json недоступны — не запрашивай пароли и не выдумывай их.
"""
